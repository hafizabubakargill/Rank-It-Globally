...
export default function BellevueSocialMediaMarketingPage() {
  return (
    <main className="marketing-page eastside-page social-bellevue-page">
      ...
      <EastsideFinalCta eyebrow="Build a clearer campaign system" title="Find the gaps between attention" accent="and conversion." body="Request a Growth Audit and we will review the message, creative journey, website experience, and measurement opportunities worth prioritizing." />
    </main>
  );
}
