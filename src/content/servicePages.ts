...
export const servicePages: Record<string, ServicePageConfig> = {
  seo: {
    ...
    ctaBody: "Request a Growth Audit and we will identify the technical, content, authority, and journey gaps worth addressing first.",
  },
  social: {
    ...
    ctaBody: "Request a Growth Audit and we will review the message, campaign journey, website experience, and measurement opportunities worth prioritizing.",
  },
  web: {
    ...
    ctaBody: "Request a Growth Audit and we will review performance, structure, SEO foundations, and conversion friction before recommending the next build step.",
  },
  design: {
    slug: "ui-ux-design",
    ...
    ctaBody: "Request a Growth Audit and we will review hierarchy, usability, mobile behavior, trust, and conversion friction before recommending the right design scope.",
  },
  cro: {
    slug: "cro-strategy",
    ...
    ctaBody: "Request a Growth Audit and we will review speed, hierarchy, proof, calls to action, forms, and measurement to identify the strongest next opportunity.",
  },
  ppc: {
    slug: "ppc-management",
    ...
    ctaBody: "Request a Growth Audit and we will review campaign intent, landing-page alignment, conversion friction, and measurement gaps worth addressing first.",
  },
  ecommerce: {
    ...
    ctaBody: "Request a Growth Audit and we will review product discovery, performance, mobile usability, conversion friction, technical SEO, and measurement to identify the strongest next opportunity.",
  },
};
