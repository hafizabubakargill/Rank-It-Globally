    ...
    <nav ref={navRef} className={mobileOpen ? "mobile-open" : ""}>
      <div className="nav-inner">
        ...
        <div className="nv" aria-label="Primary navigation">
          ...
          <Link className="cta-e" href="/growth-assessment">Book a Growth Assessment <span className="ar">→</span></Link>
        </div>
        <div className="mobile-nav-actions">
          <Link className="mobile-nav-cta" href="/growth-assessment" onClick={closeMenus}>Growth Assessment</Link>
